...
import { BookOpen, Users, Share2, Crown, Smartphone, Palette, FileText, Zap } from 'lucide-react';
          ...
          <div className="text-center">
            ...
            <AnimatedSection delay={100}>
              <h1 className="font-fraunces text-5xl sm:text-6xl md:text-7xl font-light tracking-wide text-gray-900 mb-6">
                ...
                <span className="text-coral relative">
                  Beautifully Simple
                  <svg className="absolute -bottom-2 left-0 w-full h-3 text-coral/30" viewBox="0 0 200 12" fill="currentColor">
            ...
            <AnimatedSection delay={200}>
              <p className="font-inter text-xl text-gray-600 max-w-2xl mx-auto mb-12">
                Track your reading progress with a beautiful iOS widget. Share with friends and celebrate every page turned.
              </p>
            </AnimatedSection>
            ...
            {[
              {
                ...
                title: "iOS Widget",
                description: "Glanceable reading progress right on your home screen"
              },
              {
                icon: <BookOpen className="w-7 h-7" />,
                title: "Auto Page Count",
                description: "We automatically find page counts from Open Library"
              },
              {
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <AnimatedSection>
              <span className="inline-flex items-center gap-2 px-3 py-1.5 bg-coral/10 rounded-full mb-4">
                ...
                <span className="text-sm font-inter text-coral font-medium">Universal Search</span>
              </span>
              <h2 className="font-fraunces text-4xl font-light text-gray-900 mb-4">
                Find Any Book You're Reading
              </h2>
              <p className="font-inter text-gray-600 mb-6">
                Whether you're reading a physical book, Kindle ebook, or a PDF — just search and we'll find it. 
                We automatically detect page counts so you can start tracking immediately.
              </p>
              <div className="space-y-4">
                {[
                  { icon: <BookOpen className="w-5 h-5" />, text: "Physical books from any store" },
                  { icon: <Zap className="w-5 h-5" />, text: "Kindle & ebook editions" },
                  { icon: <FileText className="w-5 h-5" />, text: "PDF books and documents" },
                ].map((item, idx) => (
                  <div key={idx} className="flex items-center gap-3 font-inter text-gray-600">
              ...
              <div className="relative">
                <div className="bg-white rounded-2xl p-6 shadow-xl border border-coral/10">
                  <div className="flex items-center gap-3 mb-4 px-4 py-3 bg-gray-50 rounded-xl">
                    ...
                    <span className="font-inter text-gray-400">Search by title, author, or ISBN...</span>
                  </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <AnimatedSection className="flex-1">
              <span className="inline-flex items-center gap-2 px-3 py-1.5 bg-coral/10 rounded-full mb-4">
                ...
                <span className="text-sm font-inter text-coral font-medium">Coming to iOS</span>
              </span>
              <h2 className="font-fraunces text-4xl font-light text-gray-900 mb-4">
      ...
      <section className="py-24 bg-cream">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="relative overflow-hidden">
            ...
            >
              {[
                { name: 'Instagram', color: 'from-purple-500 via-pink-500 to-orange-500' },
                { name: 'Snapchat', color: 'from-yellow-400 to-yellow-500' },
                { name: 'X', color: 'from-gray-800 to-black' },
                { name: 'TikTok', color: 'from-gray-900 via-pink-500 to-cyan-400' },
